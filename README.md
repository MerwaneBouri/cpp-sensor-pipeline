...
- [x] Day 2: Timestamps and performance benchmarking
- [x] Day 3: Multi-threading (producer/consumer)
- [ ] Day 4: ROS 2 integration


## Build
```bash
g++ -std=c++17 -Wall -Wextra -o buffer_test main.cpp buffer.cpp pipeline.cpp
